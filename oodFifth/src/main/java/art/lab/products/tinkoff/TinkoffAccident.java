...
public class TinkoffAccident extends Accident {
    public TinkoffAccident(final String insured, final int period, final String insurer) {
        super(insured, period, insurer, 75);
    }
